    ...
    <LayoutWrapper>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
        ...
        <div className="max-w-7xl mx-auto px-8 py-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-12">UK Tax & Salary Calculators 2026/27</h1>
              ...
              <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-6">
                {category.tools.map((tool) => (
                  ...
                  >
                    ...
                    {tool.featured && (
                      <div className="absolute -top-2 -right-2 bg-blue-700 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
                        Popular
                      </div>
                    )}
                  </Link>
