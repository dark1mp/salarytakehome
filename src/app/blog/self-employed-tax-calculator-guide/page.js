...
export const metadata = {
  ...
  alternates: {
    canonical: "https://www.salarytakehome.co.uk/blog/self-employed-tax-calculator-guide",
  },
};

export default function SelfEmployedTaxGuide() {
  return (
    <LayoutWrapper narrow breadcrumbs={[{ name: "Home", href: "/" }, { name: "Blog", href: "/blog" }, { name: "Self-Employed Tax Calculator: How to Estimate Your Tax Bill" }]}>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://www.salarytakehome.co.uk/blog/self-employed-tax-calculator-guide"
            }
          })
        }} />
