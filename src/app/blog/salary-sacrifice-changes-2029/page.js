...
export const metadata = {
  ...
  alternates: {
    canonical: "https://www.salarytakehome.co.uk/blog/salary-sacrifice-changes-2029",
  },
};

export default function SalarySacrificeChanges2029() {
  return (
    <LayoutWrapper narrow breadcrumbs={[{ name: "Home", href: "/" }, { name: "Blog", href: "/blog" }, { name: "Salary Sacrifice Pension Changes from April 2029: What You Need to Know" }]}>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <RelatedArticles articles={[
          { href: "/blog/salary-sacrifice-complete-guide", title: "Salary Sacrifice Complete Guide", category: "Pensions", description: "Full guide to current salary sacrifice rules." },
