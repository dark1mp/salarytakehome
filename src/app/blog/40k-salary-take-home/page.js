...
export default function Salary40k() {
  return (
    <LayoutWrapper narrow breadcrumbs={[{ name: "Home", href: "/" }, { name: "Blog", href: "/blog" }, { name: "£40,000 Salary Take-Home Pay in 2026/27" }]}>
                ...
                "mainEntity": [
                  {
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "On a £40,000 salary in 2026/27, you'll take home approximately £32,320 per year or £2,693 per month after income tax and National Insurance deductions."
                    }
                  },
                  {
                    "@type": "Question",
