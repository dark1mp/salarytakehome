...
export const metadata = {
  ...
  alternates: {
    canonical: "https://www.salarytakehome.co.uk/blog/uk-tax-changes-2024-25",
  },
};

export default function UKTaxChanges2024() {
  return (
    <LayoutWrapper narrow breadcrumbs={[{ name: "Home", href: "/" }, { name: "Blog", href: "/blog" }, { name: "UK Tax Changes 2024/25: What You Need to Know" }]}>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://www.salarytakehome.co.uk/blog/uk-tax-changes-2024-25"
            }
          })
        }} />
