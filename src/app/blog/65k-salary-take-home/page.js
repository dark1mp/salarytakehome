...
export const metadata = {
  ...
  alternates: {
    canonical: "https://www.salarytakehome.co.uk/blog/65k-salary-take-home",
  },
};

export default function Salary65k() {
  return (
    <LayoutWrapper narrow breadcrumbs={[{ name: "Home", href: "/" }, { name: "Blog", href: "/blog" }, { name: "£65,000 Salary Take-Home Pay in 2026/27" }]}>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-amber-50 rounded-2xl p-6 mb-8 border border-amber-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-amber-800 text-sm">At £65,000, £14,730 of your income is taxed at 40%. You&apos;re in the top 15% of UK earners.</p>
            </div>
          </div>
        </div>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            ...
            <p className="text-gray-700 leading-relaxed">
              After income tax and National Insurance, you&apos;ll take home approximately <strong>£48,257 per year</strong>, or <strong>£4,021 per month</strong>. Your effective tax rate is 25.8%.
            </p>
          </div>

          {/* Full Breakdown */}
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Full Tax Breakdown for £65,000</h2>
              ...
              <table className="w-full text-left">
                ...
                <tbody>
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="py-3 text-gray-900 text-right">£65,000</td>
                    <td className="py-3 text-gray-900 text-right">£5,417</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                  ...
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="py-3 text-gray-700 text-right">£52,430</td>
                    <td className="py-3 text-gray-700 text-right">£4,369</td>
                  </tr>
                  ...
                  <tr className="border-b border-gray-100 bg-red-100">
                    ...
                    <td className="py-3 text-red-800 text-right">-£5,892</td>
                    <td className="py-3 text-red-800 text-right">-£491</td>
                  </tr>
                  ...
                  <tr className="border-b border-gray-100 bg-orange-50">
                    ...
                    <td className="py-3 text-orange-700 text-right">-£295</td>
                    <td className="py-3 text-orange-700 text-right">-£25</td>
                  </tr>
                  <tr className="bg-green-50">
                    <td className="py-3 text-green-700 font-bold">Take-Home Pay</td>
                    <td className="py-3 text-green-700 font-bold text-right">£48,257</td>
                    <td className="py-3 text-green-700 font-bold text-right">£4,021</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                ...
                <p className="text-red-700 text-sm">
                  £65,000 - £50,270 = £14,730<br />
                  £14,730 × 40% = <strong>£5,892 higher rate tax</strong>
                </p>
              </div>
          ...
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              At £65,000, you&apos;re firmly in the <strong>higher rate tax band</strong>. About 23% of your income (£14,730) is taxed at the 40% rate.
            </p>
            <div className="bg-amber-50 rounded-xl p-6 border border-amber-200">
              <p className="text-amber-800 text-sm leading-relaxed">
                <strong>Tax planning opportunity:</strong> Every pound you contribute to a pension above the basic rate threshold saves you 40p in tax. At £65k, you could contribute up to £14,730 to a pension to bring all your income back within the basic rate band.
              </p>
            </div>
          </div>
          ...
          {/* With Student Loan */}
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">£65k with Student Loan</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <div className="grid lg:grid-cols-2 gap-4">
              <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
                ...
                <p className="text-purple-700 text-sm">Annual repayment: £3,429</p>
                <p className="text-purple-900 font-semibold">Take-home: £44,828/year</p>
              </div>
              <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
                ...
                <p className="text-purple-700 text-sm">Annual repayment: £3,205</p>
                <p className="text-purple-900 font-semibold">Take-home: £45,052/year</p>
              </div>
              <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
                <h3 className="font-semibold text-purple-800 mb-2">Plan 4 (Scotland)</h3>
                <p className="text-purple-700 text-sm">Threshold: £33,795</p>
                <p className="text-purple-700 text-sm">Annual repayment: £2,808</p>
                <p className="text-purple-900 font-semibold">Take-home: £45,449/year</p>
              </div>
              <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
                ...
                <p className="text-purple-700 text-sm">Annual repayment: £3,600</p>
                <p className="text-purple-900 font-semibold">Take-home: £44,657/year</p>
              </div>
            </div>
          </div>
          ...
          {/* Comparison */}
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">How Does £65k Compare?</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <ul className="space-y-2 text-gray-700 mb-4">
              ...
              <li>• An effective tax rate of 25.8%</li>
            </ul>
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">As a higher rate taxpayer, every £100 you put into your pension only costs you £60 after tax relief. At £65k, you have £14,730 in the higher rate band — contributing this to a pension saves you £5,892 in tax. Learn more about the <Link href="/blog/100k-tax-trap" className="text-blue-600 hover:underline">£100k tax trap</Link> to plan ahead.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Sacrificing salary for pension saves you NI too — that&apos;s an extra 2% on top of 40% tax relief on income above £50,270. Electric car and cycle to work schemes also reduce your taxable pay.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Watch child benefit thresholds</h3>
                  <p className="text-gray-600 text-sm">At £65,000, you&apos;re above the £60,000 child benefit clawback threshold. If you have children, consider using pension contributions to bring your adjusted net income below £60,000 to keep your full child benefit.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            "@graph": [
              {
                ...
                "mainEntityOfPage": {
                  "@type": "WebPage",
                  "@id": "https://www.salarytakehome.co.uk/blog/65k-salary-take-home"
                }
              },
              {
                "@type": "FAQPage",
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "How much is £65,000 after tax in the UK?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "On a £65,000 salary in 2026/27, you'll take home approximately £48,257 per year or £4,021 per month after income tax and National Insurance deductions."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "How much tax do I pay on a £65k salary?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "On £65,000 you pay £13,432 in income tax (£7,540 at the basic rate of 20% plus £5,892 at the higher rate of 40%) and £3,311 in National Insurance, totalling £16,743 in deductions."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "How much National Insurance do I pay on £65k?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "On a £65,000 salary, you pay approximately £3,311 per year in National Insurance — £3,016 at 8% on earnings between £12,570 and £50,270, plus £295 at 2% on the £14,730 above the upper threshold."
                    }
                  }
                ]
              }
        ...
        <RelatedArticles articles={[
          { href: "/blog/60k-salary-take-home", title: "£60k Salary Take Home Pay", category: "Salary Guide", description: "See how much you'd take home on a £60,000 salary." },
          { href: "/blog/70k-salary-take-home", title: "£70k Salary Take Home Pay", category: "Salary Guide", description: "Breakdown of a £70k salary after tax and NI." },
