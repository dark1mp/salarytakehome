...
export default function Salary30k() {
  return (
    <LayoutWrapper narrow breadcrumbs={[{ name: "Home", href: "/" }, { name: "Blog", href: "/blog" }, { name: "£30,000 Salary Take-Home Pay in 2026/27" }]}>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4 leading-tight">
            £30,000 Salary Take-Home Pay in 2026/27
          </h1>
                ...
                "mainEntity": [
                  {
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "On a £30,000 salary in 2026/27, you'll take home approximately £25,120 per year or £2,093 per month after income tax and National Insurance deductions."
                    }
                  },
                  {
                    "@type": "Question",
