...
export const metadata = {
  title: "£20,000 After Tax UK 2026/27 — Take-Home Pay on a £20k Salary",
  description: "Find out exactly how much you take home from a £20,000 salary in 2026/27. Full breakdown of income tax, National Insurance, and monthly take-home pay.",
  keywords: "20000 salary, 20k salary, take home pay 20000, 20k after tax, salary calculator 20000",
  openGraph: {
    title: "£20,000 After Tax UK 2026/27 — £20k Take-Home Pay",
    description: "Complete breakdown of take-home pay on a £20k salary including tax and NI deductions.",
    type: "article",
  ...
  twitter: {
    ...
    title: "£20,000 After Tax UK 2026/27 — £20k Take-Home Pay",
    description: "How much do you take home from a £20k salary? Full breakdown inside.",
  },
  alternates: {
    canonical: "https://www.salarytakehome.co.uk/blog/20k-salary-take-home",
  },
};

export default function Salary20k() {
  return (
    <LayoutWrapper narrow breadcrumbs={[{ name: "Home", href: "/" }, { name: "Blog", href: "/blog" }, { name: "£20,000 Salary Take-Home Pay in 2026/27" }]}>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4 leading-tight">
            £20,000 Salary Take-Home Pay in 2026/27
          </h1>
          <p className="text-xl text-gray-600 leading-relaxed">
            Complete breakdown of what you&apos;ll actually receive from a £20k salary after income tax and National Insurance
          </p>
        </div>

        {/* Quick Summary Box */}
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-8 mb-8 text-white">
          <h2 className="text-2xl font-bold mb-6">Quick Summary: £20,000 Salary</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white/20 rounded-xl p-4 backdrop-blur">
              <p className="text-green-100 text-sm mb-1">Annual Take-Home</p>
              <p className="text-3xl font-bold">£17,920</p>
            </div>
            <div className="bg-white/20 rounded-xl p-4 backdrop-blur">
              <p className="text-green-100 text-sm mb-1">Monthly Take-Home</p>
              <p className="text-3xl font-bold">£1,493</p>
            </div>
            <div className="bg-white/20 rounded-xl p-4 backdrop-blur">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            <p className="text-gray-700 mb-4 text-lg leading-relaxed">
              If you&apos;re earning £20,000 a year in the UK, you&apos;re below the national median salary. This is a common starting salary for entry-level positions and part-time roles. But how much of that actually ends up in your bank account?
            </p>
            <p className="text-gray-700 leading-relaxed">
              After income tax and National Insurance, you&apos;ll take home approximately <strong>£17,920 per year</strong>, or <strong>£1,493 per month</strong>. That means you&apos;re keeping about 89.6% of your gross salary — a very low effective tax rate.
            </p>
          </div>

          {/* Full Breakdown */}
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Full Tax Breakdown for £20,000</h2>
              ...
              <table className="w-full text-left">
                ...
                <tbody>
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="py-3 text-gray-900 text-right">£20,000</td>
                    <td className="py-3 text-gray-900 text-right">£1,667</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                  ...
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="py-3 text-gray-700 text-right">£7,430</td>
                    <td className="py-3 text-gray-700 text-right">£619</td>
                  </tr>
                  <tr className="border-b border-gray-100 bg-red-50">
                    <td className="py-3 text-red-700">Income Tax (20%)</td>
                    <td className="py-3 text-red-700 text-right">-£1,486</td>
                    <td className="py-3 text-red-700 text-right">-£124</td>
                  </tr>
                  <tr className="border-b border-gray-100 bg-orange-50">
                    <td className="py-3 text-orange-700">National Insurance (8%)</td>
                    <td className="py-3 text-orange-700 text-right">-£594</td>
                    <td className="py-3 text-orange-700 text-right">-£50</td>
                  </tr>
                  <tr className="bg-green-50">
                    <td className="py-3 text-green-700 font-bold">Take-Home Pay</td>
                    <td className="py-3 text-green-700 font-bold text-right">£17,920</td>
                    <td className="py-3 text-green-700 font-bold text-right">£1,493</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-amber-50 rounded-xl p-6 border border-amber-200">
                ...
                <p className="text-amber-700 text-sm">
                  £20,000 - £12,570 = £7,430 taxable<br />
                  £7,430 × 20% = <strong>£1,486 income tax</strong>
                </p>
              </div>
              ...
              <div className="bg-orange-50 rounded-xl p-6 border border-orange-200">
                ...
                <p className="text-orange-700 text-sm">
                  £7,430 × 8% = <strong>£594 National Insurance</strong>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              At £20,000, you&apos;re a <strong>basic rate taxpayer</strong>. Your entire taxable income falls within the 20% tax band.
            </p>
            <div className="bg-green-50 rounded-xl p-6 border border-green-200">
              <p className="text-green-800 text-sm leading-relaxed">
                <strong>Good news:</strong> You&apos;re well below the higher rate threshold of £50,270. You&apos;d need a pay rise of over £30,000 before any of your income gets taxed at 40%.
              </p>
            </div>
          </div>
          ...
          {/* With Student Loan */}
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">£20k with Student Loan</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">
              If you have a student loan, here&apos;s the good news — at £20,000, you&apos;re below the repayment threshold for all student loan plans:
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-4">
              <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
                ...
                <p className="text-purple-900 font-semibold">Take-home: £17,920/year</p>
              </div>
              <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
          ...
          {/* Comparison */}
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">How Does £20k Compare?</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">
              At £20,000, you&apos;re earning:
            </p>
            <ul className="space-y-2 text-gray-700 mb-4">
              <li>• <strong>Below the UK median salary</strong> (around £29,000)</li>
              <li>• A common salary for entry-level and part-time roles</li>
              <li>• An effective tax rate of just 10.4%</li>
            </ul>
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-blue-800 font-semibold">£21,520/year</p>
                </div>
                <div>
          ...
          <div className="bg-white/90 rounded-2xl p-8 mb-8 border border-gray-100 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Claim work expenses</h3>
                  <p className="text-gray-600 text-sm">If you wear a uniform or use your own tools at work, you may be able to claim tax relief from HMRC.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "Article",
                "headline": "£20,000 After Tax UK 2026/27 — Take-Home Pay on a £20k Salary",
                ...
                "mainEntityOfPage": {
                  "@type": "WebPage",
                  "@id": "https://www.salarytakehome.co.uk/blog/20k-salary-take-home"
                }
              },
              {
                "@type": "FAQPage",
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "How much is £20,000 after tax in the UK?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "On a £20,000 salary in 2026/27, you'll take home approximately £17,920 per year or £1,493 per month after income tax and National Insurance deductions."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What tax band is £20k salary in?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "A £20,000 salary falls entirely within the basic rate tax band (20%). You're well below the higher rate threshold of £50,270."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "How much National Insurance do I pay on £20k?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "On a £20,000 salary, you pay approximately £594 per year in National Insurance (8% on earnings between £12,570 and £50,270)."
                    }
                  }
                ]
              }
