...
import { Home, Clock, Heart, Briefcase, Calculator, Scale, FileText, DollarSign, HelpCircle, ExternalLink, Menu, X, Shield, HeartPulse, TrendingUp, Mail, Search, Timer, PieChart } from 'lucide-react';
...
const menuItems = [
  ...
  { href: '/dividend-tax', label: 'DIVIDEND TAX', icon: PieChart },
  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed bottom-20 left-4 z-50 w-12 h-12 bg-gradient-to-br from-[#1566a0] to-[#1e90c6] rounded-xl flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
